...
import com.example.sulemanshakil.Money.Data.CatDBContract.FeedEntry1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.getBackground().setColorFilter(new LightingColorFilter(0xFF000000, 0xff49ca5b));
        remove.getBackground().setColorFilter(new LightingColorFilter(0xFF000000, 0xF44336));
